...
export default function ProjectSettingsPage() {
  ...
  return (
    <div className="max-w-lg">
      <h1 className="type-h1 text-slate-900 mb-6">Project Settings</h1>
      ...
      <div className="surface p-4 space-y-4">
        ...
        <button onClick={handleSave} disabled={saving}
          className="bg-[#7A1B2E] text-white text-sm px-4 py-2 rounded hover:bg-[#661523] disabled:opacity-50">
